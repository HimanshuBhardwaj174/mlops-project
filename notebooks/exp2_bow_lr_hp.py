...
with mlflow.start_run():
    ...
    # X_train_df = mlflow.data.from_numpy(np.hstack([X_train,y_train.values.reshape(-1,1)]))
    # X_test_df = mlflow.data.from_numpy(np.hstack([X_test,y_test.values.reshape(-1,1)]))

    # mlflow.log_input(X_train_df,'Training')
    # mlflow.log_input(X_test_df,'Testing')
